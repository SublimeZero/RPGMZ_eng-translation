...
A window that displays the main status of the actor.

In MV, the superclass (base class) was [Window_Selectable](Window_Selectable.md), but in MZ, it has changed to [Window_StatusBase](Window_StatusBase.md).  
Additionally, parameters have been split into [Window_StatusParams](Window_StatusParams.md) and equipment into [Window_StatusEquip](Window_StatusEquip.md).

Related classes: [Scene_Status](Scene_Status.md), [Window_StatusParams](Window_StatusParams.md), [Window_StatusEquip](Window_StatusEquip.md)
...
#### block1Y () → {[Number](Number.md)}
**@MZ** Returns the y position of block 1 (default: 0 pixels).

---

#### block2Y () → {[Number](Number.md)}
**@MZ** Returns the y position of block 2.
...
#### drawBlock1 ()
Draws block 1.<br />
The y argument that existed in MV is deprecated.
...
#### drawExpInfo (x, y)
Draws experience points information.
...
#### expNextValue () → {[String](String.md)}
**@MZ** Returns the value of the next experience points.

---

#### expTotalValue () → {[String](String.md)}
**@MZ** Returns the total experience points value.
...
#### refresh ()
Override: [Window_StatusBase](Window_StatusBase.md#refresh-)
...
drawBlock3 (y), drawBlock4 (y), drawEquipments (x, y), drawHorzLine (y), drawParameters (), drawProfile (x, y), lineColor (), maxEquipmentLines ()
