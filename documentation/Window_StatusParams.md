...
**@MZ** Status parameter display window.

Related classes: [Scene_Status](Scene_Status.md), [Window_Status](Window_Status.md), [Window_StatusEquip](Window_StatusEquip.md)
...
Overrides: [Window_Selectable](Window_Selectable.md#drawitembackground-index)
...
#### setActor (actor)
Sets the actor to be displayed.
