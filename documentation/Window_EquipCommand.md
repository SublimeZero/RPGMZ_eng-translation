...
A window displaying commands ( [Equip][Best Equip][Remove All] ) arranged horizontally in the [Equip] scene.

Related Classes: [Scene_Equip](Scene_Equip.md), [RPG.EquipItem](RPG.EquipItem.md)
...
#### Parameters
In MV, the parameters were x, y, width.

| Name   | Type                    | Description               |
| ------ | ----------------------- | ------------------------- |
| `rect` | [Rectangle](Rectangle.md) | The rectangular area (in pixels) |
...
Overrides: [Window_HorzCommand](Window_HorzCommand.md#itemtextalign---string)
