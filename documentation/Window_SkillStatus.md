...
The window displayed when selecting a skill.

In MV, the superclass (parent class) was [Window_Base](Window_Base.md), but in MZ it has been changed to [Window_StatusBase](Window_StatusBase.md).

Related Classes: [Scene_Skill](Scene_Skill.md), [Window_SkillType](Window_SkillType.md), [Window_SkillList](Window_SkillList.md)
