...
This window displays switches and variables during debugging (F9).

Related classes: [Scene_Debug](Scene_Debug.md), [Window_DebugRange](Window_DebugRange.md)
...
| ------ | ------------------------ | -------------------------- |
| `rect` | [Rectangle](Rectangle.md) | The rectangle area (pixels) |

In MV, the parameters were `x`, `y`, and `width`.
...
| ---------- | ------------------- | --------------------------------- |
| `_mode`    | [String](String.md)  | [Display Mode](#display-mode)     |
| `_topId`   | [Number](Number.md)  | The ID of the first value shown   |

#### Display Mode

| String     | Description       |
| ---------- | ----------------- |
| "switch"   | Display switches   |
...
#### deltaForVariable () → {[Number](Number.md)}
Returns the movement delta based on the current key input.
...
Returns the item name for the specified ID.

##### Parameters

| Name    | Type                     | Description  |
| ------- | ------------------------ | ------------ |
| `dataId` | [Number](Number.md)      | Data ID      |
...
| Name    | Type                     | Description                |
| ------- | ------------------------ | -------------------------- |
| `mode`  | [String](String.md)      | [Display Mode](#display-mode) |

---

#### setTopId (id)
Sets the ID of the value displayed at the top.

##### Parameters

| Name    | Type                     | Description                |
| ------- | ------------------------ | -------------------------- |
| `id`    | [Number](Number.md)      | ID of the value (switch or variable) |
