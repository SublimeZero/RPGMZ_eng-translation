...
A window that displays parameter changes in the [Equip] scene.

In MV, the superclass (parent) was [Window_Base](Window_Base.md), but in MZ it has changed to [Window_StatusBase](Window_StatusBase.md).

Related Classes: [Scene_Equip](Scene_Equip.md), [RPG.EquipItem](RPG.EquipItem.md), [Window_EquipSlot](Window_EquipSlot.md), [Window_EquipItem](Window_EquipItem.md)

### new Window_EquipStatus (rect)
#### Arguments
In MV, the arguments were x, y.
...
|----------------|--------------------------|------------------------|
| `_actor`       | [Game_Actor](Game_Actor.md)         | Current actor          |
| `_tempActor`   | [Game_Actor](Game_Actor.md)         | Actor after equipping or removing items |
...
#### drawAllParams () 
**@MZ** Draws all parameters.

---

#### drawCurrentParam (x, y, paramId)
Draws the current parameter.
...
Draws the parameters after equipping.
...
**@MZ** Returns the width of the parameter (default: 48 pixels).

---

#### paramX () → {[Number](Number.md)}
**@MZ** Returns the x position of the parameter (pixels).

---

#### paramY (index) → {[Number](Number.md)}
**@MZ** Returns the y position of the parameter for the specified row (pixels).

##### Arguments

| Name   | Type                | Description           |
|--------|---------------------|-----------------------|
| `index` | [Number](Number.md) | Row number            |
...
**@MZ** Returns the width of the arrow (→) displaying before and after equipping (default: 32 pixels).
...
#### setTempActor (actor)
Sets the actor after equipping or removing items.
