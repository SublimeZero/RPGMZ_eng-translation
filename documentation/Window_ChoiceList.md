...
This window is displayed by the [Show Choices] command.

The default options are [Yes] and [No].

Changes were made in version 1.2.1.

Related Classes: [Scene_Menu](Scene_Menu.md), [Scene_Shop](Scene_Shop.md), [Window_Message](Window_Message.md)

### new Window_ChoiceList()
In MV, the constructor had a `messageWindow` parameter, but it was removed.  
In MZ's `Window`, this constructor is an exception and takes no parameters.
...
| `_background`     | [Number](Number.md)               | Background number      |
...
#### callCancelHandler()
Override: [Window_Selectable](Window_Selectable.md#callcancelhandler-)

---

#### callOkHandler()
Override: [Window_Command](Window_Command.md#callokhandler-)

---

#### contentsHeight() → {[Number](Number.md)}
Override: [Window_Selectable](Window_Selectable.md#contentsheight---number)

---

#### createCancelButton()
**@MZ** Creates the cancel button.
...
Override: [Window_Selectable](Window_Selectable.md#iscancelenabled---boolean)
...
Returns the width of the largest choice (text).

---

#### needsCancelButton() → {Boolean}
**@MZ** Determines whether a cancel button is needed.
...
**@MZ** Sets the message window.

##### Parameters

| Name           | Type                           | Description        |
| -------------- | ------------------------------ | ------------------ |
| `messageWindow` | [Window_Message](Window_Message.md) | Message window      |
...
**@MZ** Returns the window's x-coordinate.

---

#### windowY() → {[Number](Number.md)}
**@MZ** Returns the window's y-coordinate.

---

### Deprecated MV Methods
`isOkTriggered()`, `textWidthEx(text)`
