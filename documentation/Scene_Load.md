...
## Superclass: [Scene_File](Scene_File.md)

Scene for the load screen.
...
Related Classes: [SceneManager](SceneManager.md), [DataManager](DataManager.md)<br />
Related Scenes: [Scene_Save](Scene_Save.md), [Scene_Title](Scene_Title.md), [Scene_Map](Scene_Map.md)
...
| ---------------| -------- | ------------------------ |
| `_loadSuccess` | Boolean  | Indicates if the load was successful |
...
**@MZ** Loads the file with the specified ID.
...
**@MZ** Override: [Scene_File](Scene_File.md#firstsavefileid---number)


#### helpWindowText () → {[String](String.md)}
Override: [Scene_File](Scene_File.md#helpwindowtext---string)


#### initialize ()
Override: [Scene_File](Scene_File.md#initialize-)


#### mode () → {[String](String.md)}
Override: [Scene_File](Scene_File.md#mode---string)


#### onLoadFailure ()
Handler called when loading fails.


#### onLoadSuccess ()
Handler called when loading is successful.


#### onSavefileOk ()
Override: [Scene_File](Scene_File.md#onsavefileok-)


#### reloadMapIfUpdated ()
Reloads the map if it has been updated.
