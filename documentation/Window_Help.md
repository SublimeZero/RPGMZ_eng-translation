...
A window that displays explanations when an item is selected.<br />
It can also be considered a lightweight version of [Window_Message](Window_Message.md).

Related Classes: [Scene_Battle](Scene_Battle.md), [Scene_MenuBase](Scene_MenuBase.md), [Scene_File](Scene_File.md), [Window_Selectable](Window_Selectable.md)

### new Window_Help (rect)
#### Arguments
In MV, the argument was `numLines`.
...
|----------------|--------------------------|------------------------|
| `_text`        | [String](String.md)      | The text displayed     |
...
#### setItem (item)
Displays the description of the specified item.
...
| Name   | Type                | Description           |
|--------|---------------------|-----------------------|
| `text` | [String](String.md) | The text to display    |
