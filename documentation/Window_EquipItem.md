...
## Superclass: [Window_ItemList](Window_ItemList.md)

The item selection window in the [Equip] scene.

Related Classes: [Scene_Equip](Scene_Equip.md), [RPG.EquipItem](RPG.EquipItem.md), [Window_EquipSlot](Window_EquipSlot.md)

### new Window_EquipItem (rect)
#### Parameters
In MV, the parameters were x, y, width, and height.
...
| `_slotId`      | [Number](Number.md)        | [Equip Type] ID          |
...
**@MZ** Overrides: [Window_ItemList](Window_ItemList.md#colspacing---number)

---

#### etypeId () → {[Number](Number.md)}
**@MZ** Returns the [Equip Type] ID.
...
#### initialize (rect)
Overrides: [Window_ItemList](Window_ItemList.md#initialize-rect)
...
**@MZ** Overrides: [Window_ItemList](Window_ItemList.md#maxcols---number)

---

#### playOkSound ()
Overrides: [Window_Base](Window_Base.md#playoksound-)
...
#### setSlotId (slotId)
Sets the [Equip Type] ID.

##### Parameters

| Name    | Type                       | Description               |
|---------|----------------------------|---------------------------|
| `slotId`| [Number](Number.md)        | [Equip Type] ID          |
