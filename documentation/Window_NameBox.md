...
**@MZ** A window that displays the speaker's [name].

Related Class: [Window_Message](Window_Message.md)

---

### new Window_NameBox (rect)
Constructor for the `Window_NameBox` class.
...
| ---------- | ------------------ | --------------- |
| `_name`    | [String](String.md) | Name string     |
...
#### initialize (rect)
Overrides: [Window_Base](Window_Base.md#initialize-rect)
