...
Related Classes: [SceneManager](SceneManager.md), [BattleManager](BattleManager.md), [Game_Interpreter](Game_Interpreter.md)<br />
Related Scenes: [Scene_Title](Scene_Title.md), [Scene_Battle](Scene_Battle.md)
...
#### gotoTitle ()
Transitions to [Scene_Title](Scene_Title.md).

#### initialize ()
Overrides: [Scene_Base](Scene_Base.md#initialize-)

#### isTriggered ()
Checks if the confirm action (OK key/button, click/tap) has been performed.
