...
## Superclass: [Window_BattleStatus](Window_BattleStatus.md)

A window for selecting actors during battle.
...
* [actor (index) ](Window_BattleStatus.md#actor-index--game_actor)
* [basicGaugesX (rect) ](Window_BattleStatus.md#basicgaugesx-rect--number)
* [basicGaugesY (rect) ](Window_BattleStatus.md#basicgaugesy-rect--number)
* [drawItem (index)](Window_BattleStatus.md#drawitem-index)
* [drawItemImage (index)](Window_BattleStatus.md#drawitemimage-index)
* [drawItemStatus (index)](Window_BattleStatus.md#drawitemstatus-index)
* [extraHeight () ](Window_BattleStatus.md#extraheight---number)
* [faceRect (index) ](Window_BattleStatus.md#facerect-index--rectangle)
* [itemHeight () ](Window_BattleStatus.md#itemheight---number)
* [maxCols () ](Window_BattleStatus.md#maxcols---number)
* [maxItems () ](Window_BattleStatus.md#maxitems---number)
* [nameX (rect) ](Window_BattleStatus.md#namex-rect--number)
* [nameY (rect) ](Window_BattleStatus.md#namey-rect--number)
* [performPartyRefresh ()](Window_BattleStatus.md#performpartyrefresh-)
* [preparePartyRefresh ()](Window_BattleStatus.md#preparepartyrefresh-)
* [rowSpacing () ](Window_BattleStatus.md#rowspacing---number)
* [selectActor (actor) ](Window_BattleStatus.md#selectactor-actor--number)
* [stateIconX (rect) ](Window_BattleStatus.md#stateiconx-rect--number)
* [stateIconY (rect) ](Window_BattleStatus.md#stateicony-rect--number)
* [update ()](Window_BattleStatus.md#update-)
* [updatePadding ()](Window_BattleStatus.md#updatepadding-)
...
#### initialize (rect)
Override: [Window_BattleStatus](Window_BattleStatus.md#initialize-rect)
