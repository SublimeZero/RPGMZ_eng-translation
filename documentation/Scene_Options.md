...
Related Scenes: [Scene_Title](Scene_Title.md), [Scene_Menu](Scene_Menu.md)
...
| ---------------- | --------------------- | ------------------------- |
| `_optionsWindow` | [Window_Options](Window_Options.md) | Options window            |
...
**@MZ** Returns the maximum number of commands (default: 7).

#### maxVisibleCommands() → {[Number](Number.md)}
**@MZ** Returns the maximum number of visible commands (default: 12).

#### optionsWindowRect() → {[Rectangle](Rectangle.md)}
**@MZ** Returns the rectangle area for the options window.
