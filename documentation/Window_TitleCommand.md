...
Command window displayed on the title screen.

Related Classes: [Scene_Title](Scene_Title.md), [Window_Options](Window_Options.md)
...
| ----------------------- | --------------------------- | --------------------------------- |
| `_lastCommandSymbol`    | [String](String.md)        | [Static] Symbol for [Command Memory] |
...
#### initialize (rect)
Overrides: [Window_Command](Window_Command.md#initialize-rect)

---

#### isContinueEnabled () → {Boolean}
Checks if it's possible to continue from where the game left off.
