...
| ---------- | ------------- | ----------------- |
| [Follower] | [RPG.Actor](RPG.Actor.md) | [Sprite_Character](Sprite_Character.md) |

This class defines [party followers].
...
Related Classes: [Game_Followers](Game_Followers.md), [Game_Actor](Game_Actor.md), [Game_Player](Game_Player.md)
...
| ------------- | ------------------ | ----------------------------- |
| `memberIndex` | [Number](Number.md) | Party member index (1–3)      |

### Properties

| Identifier    | Type               | Description                   |
| ------------- | ------------------ | ----------------------------- |
| `_memberIndex`| [Number](Number.md) | Party member index (1–3)      |
...
Chases the specified character.

##### Parameters

| Name       | Type                            | Description                |
| ---------- | ------------------------------- | -------------------------- |
| `character`| [Game_Character](Game_Character.md) | The character to chase      |

#### initialize ()
Overrides: [Game_Character](Game_Character.md#initialize-)

#### isGathered () → {Boolean}
**@MZ** Checks if the [party members] are gathered.

#### isVisible () → {Boolean}
Checks if the [party members] are visible.
