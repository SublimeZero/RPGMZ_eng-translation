...
A window for commands that are arranged horizontally in [shop processing] ( [Items][Weapons][Armor][Important Items] ).

Related Class: [Scene_Shop](Scene_Shop.md)

### new Window_ShopCommand (rect)
#### Arguments
In MV, the arguments were width and purchaseOnly.
...
|------------------|------------------------------------|--------------------------------|
| `_windowWidth`  | [Number](Number.md)               | Width (in pixels)             |
| `_purchaseOnly` | Boolean                            | Whether [purchase only] or not |
...
#### initialize ()
Override: [Window_HorzCommand](Window_HorzCommand.md#initialize-rect)
...
Override: [Window_HorzCommand](Window_HorzCommand.md#maxcols---number)
...
| Name            | Type    | Description                    |
|-----------------|---------|--------------------------------|
| `purchaseOnly`  | Boolean | Whether it is [purchase only] or not |
