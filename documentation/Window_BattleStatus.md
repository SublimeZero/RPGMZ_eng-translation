...
## Superclass: [Window_StatusBase](Window_StatusBase.md)

This is the status display window for party members during battle.

In MV, the superclass (inherited class) was [Window_Selectable](Window_Selectable.md), but it has been changed to [Window_StatusBase](Window_StatusBase.md) in MZ.

Related Class: [Scene_Battle](Scene_Battle.md)

### new Window_BattleStatus(rect)
#### Parameters
In MV, there were no parameters.
...
#### actor(index) → {[Game_Actor](Game_Actor.md)}
**@MZ** Returns the actor at the specified index.

##### Parameters

| Name   | Type               | Description    |
| ------ | ------------------ | -------------- |
| `index` | [Number](Number.md) | Actor number   |

---

#### basicGaugesX(rect) → {[Number](Number.md)}
**@MZ** Returns the x-coordinate to draw gauges within the specified area.

##### Parameters

| Name   | Type                 | Description          |
| ------ | -------------------- | -------------------- |
| `rect` | [Rectangle](Rectangle.md) | Rectangle area       |

---

#### basicGaugesY(rect) → {[Number](Number.md)}
**@MZ** Returns the y-coordinate to draw gauges within the specified area.
...
#### drawItem(index)
Override: [Window_Selectable](Window_Selectable.md#drawitem-index)

---

#### drawItemImage(index)
**@MZ** Draws the actor image at the specified index.

---

#### drawItemStatus(index)
**@MZ** Draws the status of the actor at the specified index.

---

#### extraHeight() → {[Number](Number.md)}
**@MZ** Returns the height (default: 10).

---

#### faceRect(index) → {[Rectangle](Rectangle.md)}
**@MZ** Returns the face display rectangle for the actor at the specified index.
...
#### initialize(rect)
Override: [Window_StatusBase](Window_StatusBase.md#initialize-rect)

---

#### itemHeight() → {[Number](Number.md)}
**@MZ** Returns the item height.

---

#### maxCols() → {[Number](Number.md)}
**@MZ** Override: [Window_Selectable](Window_Selectable.md#maxcols---number)

---

#### maxItems() → {[Number](Number.md)}
Override: [Window_Selectable](Window_Selectable.md#maxitems---number)

---

#### nameX(rect) → {[Number](Number.md)}
**@MZ** Returns the x-coordinate to draw the name within the specified area.
...
**@MZ** Returns the y-coordinate to draw the name within the specified area.
...
#### performPartyRefresh()
**@MZ** Redraws the party.

---

#### preparePartyRefresh()
**@MZ** Prepares the party for redraw.

---

#### rowSpacing() → {[Number](Number.md)}
**@MZ** Override: [Window_Selectable](Window_Selectable.md#rowspacing---number)

---

#### selectActor(actor) → {[Number](Number.md)}
**@MZ** Selects the specified actor.
...
**@MZ** Returns the x-coordinate to draw state icons within the specified area.
...
**@MZ** Returns the y-coordinate to draw state icons within the specified area.
...
#### update()
**@MZ** Override: [Window_Selectable](Window_Selectable.md#update-)

---

#### updatePadding()
**@MZ** Override: [Window_Base](Window_Base.md#updatepadding-)

---

### Deprecated MV Methods
`basicAreaRect(index)`, `gaugeAreaRect(index)`, `gaugeAreaWidth()`, `numVisibleRows()`, `refresh()`, `windowHeight()`, `windowWidth()`

`drawBasicArea(rect, actor)`, `drawGaugeArea(rect, actor)`, `drawGaugeAreaWithoutTp(rect, actor)`, `drawGaugeAreaWithTp(rect, actor)`
