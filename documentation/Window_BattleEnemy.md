...
A window for selecting enemies.
...
Returns the currently selected [enemy character].

---

#### enemyIndex () → {[Number](Number.md)}
Returns the number of the currently selected [enemy character].

---

#### hide ()
Override: [Window_Base](Window_Base.md#hide-)
...
#### processTouch ()
**@MZ** Override: [Window_Selectable](Window_Selectable.md#processtouch-)
...
#### select (index)
Override: [Window_Selectable](Window_Selectable.md#select-index)

---

#### show ()
Override: [Window_Base](Window_Base.md#show-)
