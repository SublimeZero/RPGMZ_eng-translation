...
Related Classes: [SceneManager](SceneManager.md), [DataManager](DataManager.md), [Game_Interpreter](Game_Interpreter.md)<br />
Related Scenes: [Scene_Load](Scene_Load.md), [Scene_Menu](Scene_Menu.md)
...
**@MZ** Saves to the file with the specified ID.
...
#### onSaveFailure ()
Handler called when saving fails.


#### onSavefileOk ()
Override: [onSavefileOk ()](Scene_File.md#onsavefileok-)


#### onSaveSuccess ()
Handler called when saving is successful.
