...
|-----------------|----------------------------|--------------------------------------|
| `_commandWindow` | [Window_GameEnd](Window_GameEnd.md) | [Game End] selection window         |
...
#### commandToTitle ()
Executes the [Title] command.

#### commandWindowRect () → {[Rectangle](Rectangle.md)}
**@MZ** Returns the rectangular area of the command selection window.
...
#### createCommandWindow ()
Generates the command selection window.
