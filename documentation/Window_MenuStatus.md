...
A window that displays party members' status in the menu.<br />
It is used for actor selection in [skills], [equipment], and [status], and also for [formation].

In MV, the superclass was [Window_Selectable](Window_Selectable.md), but in MZ it was changed to [Window_StatusBase](Window_StatusBase.md).

Changes were made in versions v1.1.1 and v1.2.0.

Related classes: [Scene_Menu](Scene_Menu.md), [Window_MenuCommand](Window_MenuCommand.md)
...
| ----------------- | ----------------- | ---------------------------------- |
| `_formationMode`  | Boolean           | Whether it is in [formation] mode  |
| `_pendingIndex`   | [Number](Number.md)| Pending actor index                |
...
#### actor (index) → {[RPG.Actor](RPG.Actor.md)}
**@MZ** Returns the actor at the specified item index.

##### Arguments

| Name   | Type              | Description     |
| ------ | ----------------- | --------------- |
| `index`| [Number](Number.md)| Item index      |
...
**@MZ** Draws the background for the pending actor.

##### Arguments

| Name   | Type              | Description     |
| ------ | ----------------- | --------------- |
| `index`| [Number](Number.md)| Actor index     |

---

#### drawItemImage (index)
Draws the image of the specified actor.
...
Draws the status of the specified actor.
...
Checks if the window is in formation change mode.
...
Override: [Window_Selectable](Window_Selectable.md#itemheight---number)
...
Returns the index of the pending actor.

---

#### processOk ()
Override: [Window_Selectable](Window_Selectable.md#processok-)

---

#### selectLast ()
Selects the actor that was last chosen.

---

#### setFormationMode (formationMode)
Sets the formation change mode.

##### Arguments

| Name            | Type    | Description              |
| --------------- | ------- | ------------------------ |
| `formationMode` | Boolean | Whether formation can be changed |

---

#### setPendingIndex (index)
Sets the index of the pending actor.
...
`drawItemBackground (index)`, `loadImages ()`, `windowHeight ()`, `windowWidth ()`
