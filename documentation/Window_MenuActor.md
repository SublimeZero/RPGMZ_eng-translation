...
## Superclass: [Window_MenuStatus](Window_MenuStatus.md)

A window used to select an actor in the [items] and [skills] menu.

Related classes: [Scene_ItemBase](Scene_ItemBase.md), [Scene_Item](Scene_Item.md), [Scene_Skill](Scene_Skill.md)
...
* [actor (index)](Window_MenuStatus.md#actor-index--rpgactor)
* [drawItem (index)](Window_MenuStatus.md#drawitem-index)
* [drawItemImage (index)](Window_MenuStatus.md#drawitemimage-index)
* [drawItemStatus (index)](Window_MenuStatus.md#drawitemstatus-index)
* [formationMode ()](Window_MenuStatus.md#formationmode---boolean)
* [isCurrentItemEnabled ()](Window_MenuStatus.md#iscurrentitemenabled---boolean)
* [itemHeight ()](Window_MenuStatus.md#itemheight---number)
* [maxItems () ](Window_MenuStatus.md#maxitems---number)
* [numVisibleRows ()](Window_MenuStatus.md#numvisiblerows---number)
* [pendingIndex ()](Window_MenuStatus.md#pendingindex---number)
* [setFormationMode (formationMode)](Window_MenuStatus.md#setformationmode-formationmode)
* [setPendingIndex (index)](Window_MenuStatus.md#setpendingindex-index)
...
#### initialize (rect)
Override: [Window_MenuStatus](Window_MenuStatus.md#initialize-x-y)

---

#### processOk ()
Override: [Window_MenuStatus](Window_MenuStatus.md#processok-)

---

#### selectForItem (item)
Sets the selected item or skill.

##### Arguments

| Name  | Type                     | Description                |
| ----- | ------------------------ | -------------------------- |
| `item`| [RPG.BaseItem](RPG.BaseItem.md) | Item or skill             |

---

#### selectLast ()
Override: [Window_MenuStatus](Window_MenuStatus.md#selectlast-)
