...
A window that displays the [map display name].
...
Related class: [Scene_Map](Scene_Map.md)
...
| ------------- | ------------------ | -------------------------- |
| `_showCount`  | [Number](Number.md) | Display duration (in frames) |
...
#### close ()
Override: [Window_Base](Window_Base.md#close-)
...
#### updateFadeIn ()
Updates the fade-in effect.

---

#### updateFadeOut ()
Updates the fade-out effect.
