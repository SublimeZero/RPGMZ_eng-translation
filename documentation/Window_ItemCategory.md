...
## Superclass: [Window_HorzCommand](Window_HorzCommand.md)

A window for commands arranged horizontally, used in [items] and [shop processing] for [selling] ( [Items][Weapons][Armor][Key Items] ).

Related Classes: [Scene_Item](Scene_Item.md), [Scene_Shop](Scene_Shop.md)
...
|---------------|----------------------------|-------------------|
| `_itemWindow` | [Window_ItemList](Window_ItemList.md) | Item window       |
...
* [itemTextAlign ()](Window_HorzCommand.md#itemtextalign---string)
...
#### initialize (rect)
Overrides: [Window_HorzCommand](Window_HorzCommand.md#initialize-rect)
...
**@MZ** Determines if the specified [item category] should be displayed.

##### Arguments

| Name   | Type                | Description                   |
|--------|---------------------|-------------------------------|
| `name` | [String](String.md) | [Item Category](#item-category) |

---

#### needsSelection () → {Boolean}
**@MZ** Checks if there are multiple item categories and if selection is needed.

---

#### setItemWindow (itemWindow)
Sets the specified item window as the content display window.

##### Arguments

| Name        | Type                             | Description            |
|-------------|----------------------------------|------------------------|
| `itemWindow`| [Window_ItemList](Window_ItemList.md) | Item window            |
