...
This is a command selection window.

Each command item has both a "display name" shown on the screen and an internal "symbol" used for identification, so be aware of the distinction.

### new Window_Command(rect)
#### Parameters
In MV, the parameters were `x` and `y`.
...
| ---------- | ---------------------------------------------------- | ---------------------------------- |
| `_list`    | [Array](Array.md).&lt;[MV.CommandItem](MV.CommandItem.md)&gt; | Array of command items             |
...
| --------- | ------------------- | ----------------- | ---------------------- |
| `name`    | [String](String.md)  |                   | Display name           |
| `symbol`  | [String](String.md)  |                   | Symbol                 |
| `enabled` | Boolean              | &lt;optional&gt;  | Is selectable (default: true) |
| `ext`     | *                   | &lt;optional&gt;  | Additional information (default: null) |

---

#### callOkHandler()
Override: [Window_Selectable](Window_Selectable.md#callokhandler-)

---

#### commandName(index) → {[String](String.md)}
Returns the display name of the command item at the specified index.

##### Parameters

| Name     | Type                | Description              |
| -------- | ------------------- | ------------------------ |
| `index`  | [Number](Number.md)  | Command item index       |

---

#### commandSymbol(index) → {[String](String.md)}
Returns the symbol of the command item at the specified index.
...
Returns the object of the currently selected command item.

---

#### currentExt() → {*}
Returns the additional information of the currently selected command item.

---

#### currentSymbol() → {[String](String.md)}
Returns the symbol of the currently selected command item.
...
Returns the index of the command item with the specified additional information.
...
Returns the index of the command item with the specified symbol.
...
Returns whether the command item at the specified index is enabled.
...
Override: [Window_Selectable](Window_Selectable.md#iscurrentitemenabled---boolean)

---

#### isOkEnabled() → {Boolean}
Override: [Window_Selectable](Window_Selectable.md#isokenabled---boolean)
...
#### makeCommandList()
Adds all items to the menu. Individual items are added via [addCommand](Window_Command.md#addcommand-name-symbol-enabled-ext).
...
#### selectExt(ext)
Selects a command item based on the specified additional information.
...
#### selectSymbol(symbol)
Selects a command item based on the specified symbol.
