...
A window for selecting files during save/load operations.

Related Classes: [Scene_File](Scene_File.md), [Scene_Save](Scene_Save.md), [Scene_Load](Scene_Load.md)
...
|---------------|--------------------------|----------------------------------|
| `_autosave`   | Boolean                  | **@MZ** Is it auto-save?        |
| `_mode`       | [String](String.md)      | [Read/Write Mode](#readwrite-mode) |
...
##### Arguments
The `valid` argument that existed in MV is deprecated.

| Name  | Type                     | Description                    |
|-------|--------------------------|--------------------------------|
| `info` | Object                   | Information {key: String}     |
...
Draws the specified party character.
...
**@MZ** Draws the title of the save file at the specified position.
...
**@MZ** Returns the save file ID corresponding to the specified file number.

##### Arguments

| Name   | Type                     | Description        |
|--------|--------------------------|--------------------|
| `index` | [Number](Number.md)      | File number        |
...
**@MZ** Checks if the specified save file ID is enabled for save/load.
...
**@MZ** Returns the number of visible rows (default: 5).
...
**@MZ** Returns the ID of the currently selected save file.

---

#### savefileIdToIndex (savefileId) → {[Number](Number.md)}
**@MZ** Returns the file number corresponding to the specified save file ID.
...
**@MZ** Selects the file corresponding to the specified save file ID.
...
| Name      | Type                     | Description                          |
|-----------|--------------------------|--------------------------------------|
| `mode`    | [String](String.md)      | [Read/Write Mode](#readwrite-mode) |
| `autosave` | Boolean                  | **@MZ** Is it auto-save?           |
