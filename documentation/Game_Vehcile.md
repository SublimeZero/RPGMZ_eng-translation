...
| --- | --- | --- |
| [Vehicles] | [RPG.System.Vehicle](RPG.System.Vehicle.md) | [Sprite_Character](Sprite_Character.md) |

A class that defines [vehicles]. <br />
It has a name that suggests it is for land transportation, but it does not support land vehicles.
...
| --- | --- | --- |
| `type` | [String](String.md) | [Type of vehicle](#[vehicle-types]) |
...
| --- | --- | --- |
| `_type` | [String](String.md) | [Type of vehicle](#[vehicle-types]) |
| `_mapId` | [Number](Number.md) | Map ID |
| `_altitude` | [Number](Number.md) | Altitude |
| `_driving` | Boolean | Whether it is currently being driven |
| `_bgm` | [RPG.AudioFile](RPG.AudioFile.md) | BGM for the vehicle |
...
#### canMove () → {Boolean}
Whether the vehicle can be operated.
...
#### initialize (type)
Override: [Game_Character](Game_Character.md#initialize-)


#### initMembers ()
Override: [Game_Character](Game_Character.md#initmembers-)
...
#### isAirship () → {Boolean}
Whether it is an airship.


#### isBoat () → {Boolean}
Whether it is a small boat.


#### isHighest () → {Boolean}
Whether it is at the highest altitude.


#### isLandOk (x, y, d) → {Boolean}
Whether it can land at the specified position and direction.
...
| `d` | [Number](Number.md) | direction (numeric keypad compatible) |


#### isLowest () → {Boolean}
Whether it is landing (at the lowest altitude).
...
#### loadSystemSettings ()
Load system settings and apply them.


#### maxAltitude () → {[Number](Number.md)}
Returns the maximum altitude (in pixels).


#### playBgm ()
Play the BGM for the vehicle.


#### pos (x, y) → {Boolean}
Override: [Game_CharacterBase](Game_CharacterBase.md#pos-)
...
#### resetDirection ()
Reset the vehicle's direction (to left).


#### setBgm (bgm)
Set the BGM for the vehicle.
...
Move to the specified map and position.
...
Returns the shadow opacity (0-255).


#### shadowX () → {[Number](Number.md)}
Returns the x-coordinate of the shadow on the screen (in pixels).


#### shadowY () → {[Number](Number.md)|[Number](Number.md)}
Returns the y-coordinate of the shadow on the screen (in pixels).


#### syncWithPlayer ()
Align with the player's position.
...
Update the altitude of the airship.


#### vehicle () → {[RPG.System.Vehicle](RPG.System.Vehicle.md)}
Returns the current vehicle information object.
