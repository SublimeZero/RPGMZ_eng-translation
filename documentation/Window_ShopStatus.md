...
A window that displays the [quantity owned] and the equipability of party members during item selection in the shop.

In MV, the superclass (base class) was [Window_Base](Window_Base.md), but it has been changed to [Window_StatusBase](Window_StatusBase.md) in MZ.

Related Classes: [Scene_Shop](Scene_Shop.md), [Window_ShopBuy](Window_ShopBuy.md), [Window_ShopNumber](Window_ShopNumber.md)
...
|------------|------------------------------------|------------------------------|
| `_item`    | [RPG.BaseItem](RPG.BaseItem.md)   | Item information             |
...
Returns the equipped item information for the specified actor and equipment type.
...
Draws the actor's equipment information.
...
Draws the changes in parameters.
...
| `y`     | [Number](Number.md)                | y-coordinate (in pixels)       |
| `actor` | [Game_Actor](Game_Actor.md)       | Actor                           |
| `item1` | [RPG.EquipItem](RPG.EquipItem.md) | Equipment information           |

---

#### drawEquipInfo (x, y)
Draws the equipment information.
...
#### isEquipItem () → {Boolean}
Checks if it is an equip item.

---

#### isPageChangeEnabled () → {Boolean}
Checks if page change is enabled.

---

#### isPageChangeRequested () → {Boolean}
Checks if a page change has been requested.
...
| Name    | Type                               | Description                     |
|---------|------------------------------------|---------------------------------|
| `item`  | [RPG.BaseItem](RPG.BaseItem.md)   | Item information                |
...
#### update ()
Override: [Window_Base](Window_Selectable.md#update-)
