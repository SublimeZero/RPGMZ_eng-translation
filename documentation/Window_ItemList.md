...
The selection window for [items].

Related classes: [Scene_Item](Scene_Item.md), [Window_ItemCategory](Window_ItemCategory.md)
...
|------------|--------------------------------------------|---------------------------------|
| `_category`| [String](String.md)                        | [Item Category](#item-category) |
...
**@MZ** Override: [Window_Selectable](Window_Selectable.md#colspacing---number)
...
Draws the number of the specified item.

##### Arguments

| Name    | Type                              | Description                       |
|---------|-----------------------------------|-----------------------------------|
| `item`  | [RPG.BaseItem](RPG.BaseItem.md) | The item                          |
| `x`     | [Number](Number.md)              | Window x-coordinate (pixels)      |
| `y`     | [Number](Number.md)              | Window y-coordinate (pixels)      |
| `width` | [Number](Number.md)              | Window width (pixels)             |

---

#### includes (item) → {Boolean}
Checks if the specified item is included.
...
Checks if the specified item is available.
...
**@MZ** Returns the item at the specified index.
...
Override: [Window_Selectable](Window_Selectable.md#maxcols---number)
...
#### needsNumber () → {Boolean}
Checks if a number is needed.

---

#### numberWidth () → {[Number](Number.md)}
Returns the width of the number (pixels).
