...
Related Classes: [SceneManager](SceneManager.md), [RPG.EquipItem](RPG.EquipItem.md)<br />
...
| `_commandWindow` | [Window_EquipCommand](Window_EquipCommand.md) | Command selection window |
| `_slotWindow` | [Window_EquipSlot](Window_EquipSlot.md) | Slot selection window |
| `_itemWindow` | [Window_EquipItem](Window_EquipItem.md) | Equipment selection window |
...
**@MZ** Checks if the page buttons are enabled.

#### commandClear ()
Executes the [Clear All] command.

#### commandEquip ()
Executes the [Equip] command.

#### commandOptimize ()
Executes the [Optimize Equipment] command.
...
#### createItemWindow ()
Generates the equipment selection window.

#### createSlotWindow ()
Generates the equipment slot selection window.

#### createStatusWindow ()
Generates the status window.

#### executeEquipChange ()
**@MZ** Changes to the currently selected equipment.

#### hideItemWindow ()
**@MZ** Hides the item window.
...
#### onItemCancel ()
Handler called when the equipment selection is canceled.

#### onItemOk ()
Handler called when the equipment selection is confirmed.

#### onSlotCancel ()
Handler called when the slot selection is canceled.

#### onSlotOk ()
Handler called when the slot selection is confirmed.

#### refreshActor ()
Redraws the actor.

#### slotWindowRect () → {[Rectangle](Rectangle.md)}
**@MZ** Returns the rectangular area of the equipment slot selection window.

#### statusWidth () → {[Number](Number.md)}
**@MZ** Returns the width of the status window (default: 312).
