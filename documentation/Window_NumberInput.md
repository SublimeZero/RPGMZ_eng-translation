...
A window for handling [number input processing].

Related class: [Window_EventItem](Window_EventItem.md)

### new Window_NumberInput ()
#### Arguments
In MV, the argument was `messageWindow`, but it has been removed.

### Properties

| Identifier      | Type                                               | Description                |
| --------------- | -------------------------------------------------- | -------------------------- |
| `_messageWindow` | [Window_Message](Window_Message.md)               | The parent message window   |
| `_number`       | [Number](Number.md)                               | The number being input      |
| `_maxDigits`    | [Number](Number.md)                               | Maximum number of digits    |
| `_buttons`      | [Array](Array.md).&lt;[Sprite_Button](Sprite_Button.md)&gt; | Array of buttons           |
...
Returns the Y coordinate of the button (in pixels).

---

#### changeDigit (up)
Changes the currently edited digit.

##### Arguments

| Name | Type    | Description      |
| ---- | ------- | ---------------- |
| `up` | Boolean | Whether to increase the digit |

---

#### createButtons ()
Generates buttons for input.
...
#### onButtonDown ()
Handler called when the digit is decreased and selected.

---

#### onButtonOk ()
Handler called when OK is selected.

---

#### onButtonUp ()
Handler called when the digit is increased and selected.

---

#### placeButtons ()
Positions the buttons for input.

---

#### processDigitChange ()
Executes the digit change.
...
| Name            | Type                                    | Description         |
| --------------- | --------------------------------------- | ------------------- |
| `messageWindow` | [Window_Message](Window_Message.md)    | The message window   |
...
isOkTriggered (), hideButtons (), showButtons (), spacing (), updateButtonsVisibility ()
