...
The selection window for [skills].

Related Classes: [Scene_Skill](Scene_Skill.md), [Window_SkillType](Window_SkillType.md)
...
| `_stypeId` | [Number](Number.md)               | [Skill Type ID](RPG.Skill.md#スキルタイプid) |
| `_data`    | [Array](Array.md).&lt;[RPG.Skill](RPG.Skill.md)&gt; | Array of skills                |
...
**@MZ** Overrides: [Window_Selectable](Window_Selectable.md#colspacing---number)

---

#### costWidth () → {[Number](Number.md)}
Returns the width (in pixels) for the consumption cost.
...
Draws the consumption cost of the specified skill.
...
| `width`| [Number](Number.md)               | Window width (in pixels)        |

---

#### includes (item) → {Boolean}
Checks if the specified skill is included.

##### Arguments

| Name   | Type                               | Description                      |
|--------|------------------------------------|----------------------------------|
| `item` | [RPG.Skill](RPG.Skill.md)        | Skill                            |
...
Checks if the specified skill is available.
...
**@MZ** Returns the skill at the specified item number.
