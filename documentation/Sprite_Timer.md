...
A sprite for displaying the timer.

| Event Command       | Object                        |
| ------------------- | ----------------------------- |
| [Control Timer]      | [Game_Timer](Game_Timer.md)   |

Related Classes: [Game_Interpreter](Game_Interpreter.md), [Spriteset_Base](Spriteset_Base.md)
...
| ----------- | ------------------ | ------------- |
| `_seconds`  | [Number](Number.md) | The number of seconds |
...
**@MZ** Returns the font name.

---

#### fontSize () → {[Number](Number.md)}
**@MZ** Returns the font size.
