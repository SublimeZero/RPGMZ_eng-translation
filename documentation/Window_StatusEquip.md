...
**@MZ** Status equipment display window.

Related Classes: [Scene_Status](Scene_Status.md), [Window_Status](Window_Status.md), [Window_StatusParams](Window_StatusParams.md)

### new Window_StatusEquip (rect)
#### Arguments
...
Override: [Window_Selectable](Window_Selectable.md#drawitembackground-index)
