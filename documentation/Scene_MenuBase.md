...
Related Scenes: [Scene_Map](Scene_Map.md), [Scene_Item](Scene_Item.md), [Scene_Skill](Scene_Skill.md), [Scene_Equip](Scene_Equip.md), [Scene_Status](Scene_Status.md), [Scene_Options](Scene_Options.md), [Scene_Save](Scene_Save.md), [Scene_GameEnd](Scene_GameEnd.md)
...
|----------------------|--------------------------|-------------------------------|
| `_commandWindow`     | [Window_MenuCommand](Window_MenuCommand.md) | Command selection window       |
| `_statusWindow`      | [Window_MenuStatus](Window_MenuStatus.md)   | Status display and selection window |
| `_goldWindow`        | [Window_Gold](Window_Gold.md)                | Gold display window            |
...
#### commandFormation ()
Executes the [Formation] command.

#### commandGameEnd ()
Executes the [Game End] command.
...
#### commandPersonal ()
Switches to the mode for selecting an actor.
...
**@MZ** Returns the rectangular area of the gold window.
...
#### onFormationCancel ()
Handler called when the [Formation] is canceled.

#### onFormationOk ()
Handler called when the [Formation] is confirmed.
