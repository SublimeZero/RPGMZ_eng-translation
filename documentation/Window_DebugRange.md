...
A window for displaying the range of switches and variables in the debug (F9) mode.

Related Classes: [Scene_Debug](Scene_Debug.md), [Window_DebugEdit](Window_DebugEdit.md)
...
| ------------ | ----------------------- | ------------------------------------------ |
| `lastTopRow` | [Number](Number.md)     | [static] The top row of the last selected screen |
| `lastIndex`  | [Number](Number.md)     | [static] The index of the last selected value |
| `_editWindow`| [Window_DebugEdit](Window_DebugEdit.md) | The edit window |
...
#### isSwitchMode (index) → {Boolean}
**@MZ** Checks if the specified index is a switch.

##### Parameters

| Name   | Type                    | Description             |
| ------ | ----------------------- | ----------------------- |
| `index` | [Number](Number.md)     | The index of the value  |
...
#### mode (index) → {[String](String.md)}
Determines and returns the [display mode](Window_DebugEdit.md#表示モード) for the specified index.
...
| Name       | Type                          | Description      |
|------------|-------------------------------|------------------|
| `editWindow` | [Window_DebugEdit](Window_DebugEdit.md) | The edit window  |

---

#### topId (index) → {[Number](Number.md)}
Returns the ID of the top value from the specified index.
...
refresh (), windowHeight (), windowWidth ()
