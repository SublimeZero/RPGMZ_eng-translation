...
A window for selecting quantities during buying and selling in [shop processing].

The image from img/system/ButtonSet.png is used.

Related Classes: [Scene_Shop](Scene_Shop.md), [Window_ShopBuy](Window_ShopBuy.md), [Window_ShopStatus](Window_ShopStatus.md)

### new Window_ShopNumber (rect)
#### Arguments
In MV, the arguments were x, y, and height.
...
|------------------|------------------------------------|--------------------------------|
| `_item`         | [RPG.BaseItem](RPG.BaseItem.md)   | The item for buying and selling |
| `_max`          | [Number](Number.md)               | Maximum quantity                |
| `_price`        | [Number](Number.md)               | Price                           |
| `_number`       | [Number](Number.md)               | Quantity                        |
| `_currencyUnit` | [String](String.md)               | Currency unit                   |
| `_buttons`      | [Array](Array.md).&lt;[Sprite_Button](Sprite_Button.md)&gt; | Array of button sprites         |
...
**@MZ** Returns the spacing between buttons (default: 8 pixels).

---

#### buttonY () → {[Number](Number.md)}
Returns the y-coordinate (in pixels) of the button.

---

#### changeNumber (amount)
Changes to the specified quantity.
...
Returns the cursor width (in pixels).
...
#### drawCurrentItemName ()
**@MZ** Draws the name of the currently selected item.

---

#### drawHorzLine ()
**@MZ** Draws a horizontal line.

---

#### drawMultiplicationSign ()
Draws × (character code: 00d7).
...
**@MZ** Override: [Window_Selectable](Window_Selectable.md#isscrollenabled---boolean)

---

#### itemNameY () → {[Number](Number.md)}
**@MZ** Returns the y position of the item name.

---

#### itemRect (index) → {[Rectangle](Rectangle.md)}
**@MZ** Override: [Window_Selectable](Window_Selectable.md#itemrect-index--rectangle)

---

#### isTouchOkEnabled () → {Boolean}
**@MZ** Override: [Window_Selectable](Window_Selectable.md#istouchokenabled---boolean)
...
**@MZ** Returns × (character code: 00d7).

---

#### multiplicationSignX () → {[Number](Number.md)}
**@MZ** Returns the x position of ×.
...
#### onButtonDown ()
Handler called when the down button is selected.

---

#### onButtonDown2 ()
Handler called when the down 2 button is selected.

---

#### onButtonOk ()
Handler called when the OK button is selected.

---

#### onButtonUp ()
Handler called when the up button is selected.

---

#### onButtonUp2 ()
Handler called when the up 2 button is selected.
...
#### playOkSound ()
Override: [Window_Selectable](Window_Selectable.md#playoksound-)

---

#### totalPriceY () → {[Number](Number.md)}
**@MZ** Returns the y position of the total price.

---

#### processNumberChange ()
Processes the change of quantity.
...
| `max`   | [Number](Number.md)               | Maximum quantity             |
| `price` | [Number](Number.md)               | Price                        |

---

#### totalButtonWidth () → {[Number](Number.md)}
**@MZ** Returns the total width of all buttons.

---

#### update ()
Override: [Window_Selectable](Window_Selectable.md#update-)

---

### Deprecated MV Methods
isOkTriggered (), itemY (), priceY (), updateButtonsVisibility (), updateCursor (), showButtons (), windowWidth ()
