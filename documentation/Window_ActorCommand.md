...
A window for the actor's commands in the battle scene ([Attack][Skill][Defense][Item]).
...
**@MZ** Returns the actor.

---

#### addAttackCommand ()
Adds the [Attack] command.

---

#### addGuardCommand ()
Adds the [Defense] command.

---

#### addItemCommand ()
Adds the [Item] command.

---

#### addSkillCommands ()
Adds the [Skill] command.
...
#### setup (actor)
Sets up the commands for the specified actor.

##### Arguments

| Name   | Type              | Description      |
| ------ | ----------------- | ---------------- |
| `actor` | [Game_Actor](Game_Actor.md) | The actor       |

---

### Deprecated MV Commands
