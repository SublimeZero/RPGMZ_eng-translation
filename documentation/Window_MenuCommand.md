...
A window for menu commands ([items], [skills], [equipment], [status], [formation], [options], [save], [game end]).

Related classes: [Scene_Menu](Scene_Menu.md), [Window_MenuStatus](Window_MenuStatus.md), [Window_Gold](Window_Gold.md)
...
| -------------------- | ----------------- | ------------------------------------ |
| `_lastCommandSymbol` | [String](String.md) | Symbol for [Static] [command memory] |
...
#### addFormationCommand ()
Adds the [formation] command if available.

---

#### addMainCommands ()
Adds the main commands ([items], [skills], [equipment], [status]) if checked in [menu commands].

---

#### addOriginalCommands ()
Used to add original commands via plugins.

---

#### addOptionsCommand ()
Adds the [options] command if available.

---

#### addSaveCommand ()
Adds the [save] command if checked in [menu commands].

---

#### addGameEndCommand ()
Adds the [game end] command if the game can end.

---

#### areMainCommandsEnabled () → {Boolean}
Checks if the main commands ([items], [skills], [equipment], [status]) are usable (i.e., if there are party members).
...
Checks if the [menu commands] are checked and if there are multiple party members, verifying if [formation] is available.

---

#### isGameEndEnabled () → {Boolean}
Checks if the [game end] option is available (default: true).

---

#### isOptionsEnabled () → {Boolean}
Checks if [options] is available (default: true).

---

#### isSaveEnabled () → {Boolean}
Checks if [menu commands] are checked and if [save] is available (not during event [test] execution).
...
Checks if it is marked as needed (checked) in [menu commands].

##### Arguments

| Name  | Type              | Description                |
| ----- | ----------------- | -------------------------- |
| `name`| [String](String.md) | [Command name](#command-names) |
...
#### selectLast ()
Selects the last menu chosen.

---

### Deprecated MV Methods
`numVisibleRows()`, `windowWidth()`
