...
A window for handling [item selection].

Changes made in v1.8.0.

Related Class: [Window_NumberInput](Window_NumberInput.md)

### new Window_EventItem (rect)
#### Arguments
In MV, the argument was `messageWindow`.
...
|----------------|--------------------------|------------------------|
| `_messageWindow` | [Window_Message](Window_Message.md) | Parent message window  |
...
Override: [Window_ItemList](Window_ItemList.md#includes-item--boolean)

---

#### initialize (rect)
Override: [Window_ItemList](Window_ItemList.md#initialize-rect)

---

#### isEnabled (item) → {Boolean}
Override: [Window_ItemList](Window_ItemList.md#isenabled-item--boolean)

---

#### needsNumber () → {Boolean}
**@MZ** Override: [Window_ItemList](Window_ItemList.md#needsnumber---boolean)

---

#### onCancel ()
Handler called when cancel is selected.
