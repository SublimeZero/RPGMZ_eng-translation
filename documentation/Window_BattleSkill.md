...
## Superclass: [Window_SkillList](Window_SkillList.md)

Skill selection window in the battle scene.
...
* [colSpacing ()](Window_SkillList.md#colspacing---number)
* [costWidth ()](Window_SkillList.md#costwidth---number)
* [drawItem (index)](Window_SkillList.md#drawitem-index)
* [drawSkillCost (skill, x, y, width)](Window_SkillList.md#drawskillcost-skill-x-y-width)
* [includes (item)](Window_SkillList.md#includes-item--boolean)
* [isCurrentItemEnabled ()](Window_SkillList.md#iscurrentitemenabled---boolean)
* [isEnabled (item)](Window_SkillList.md#isenabled-item--boolean)
* [item ()](Window_SkillList.md#item---rpgskill)
* [itemAt (index)](itemat-index--rpgskill)
* [makeItemList ()](Window_SkillList.md#makeitemlist-)
* [maxCols ()](Window_SkillList.md#maxcols---number)
* [maxItems ()](Window_SkillList.md#maxitems---number)
* [refresh ()](Window_SkillList.md#refresh-)
* [selectLast ()](Window_SkillList.md#selectlast-)
* [setActor (actor)](Window_SkillList.md#setactor-actor)
* [setStypeId (stypeId)](Window_SkillList.md#setstypeid-stypeid)
...
#### initialize (rect)
Override: [Window_SkillList](Window_SkillList.md#initialize-rect)
