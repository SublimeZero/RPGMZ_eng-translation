...
A window used for selecting characters in the [name input process].

Related Class: [Scene_Name](Scene_Name.md)
...
#### Arguments
In MV, the argument was `editWindow`.

| Name   | Type                    | Description          |
| ------ | ----------------------- | -------------------- |
| `rect` | [Rectangle](Rectangle.md) | The rectangle area (in pixels) |
...
| ----------- | --------------------------------------------- | ------------------------------------ |
| `LATIN1`    | [Array](Array.md).&lt;[String](String.md)&gt; | [static] Array of alphabet letters   |
| `LATIN2`    | [Array](Array.md).&lt;[String](String.md)&gt; | [static] Array of accented Latin letters |
| `RUSSIA`    | [Array](Array.md).&lt;[String](String.md)&gt; | [static] Array of Cyrillic characters |
| `JAPAN1`    | [Array](Array.md).&lt;[String](String.md)&gt; | [static] Array of Hiragana characters |
| `JAPAN2`    | [Array](Array.md).&lt;[String](String.md)&gt; | [static] Array of Katakana characters |
| `JAPAN3`    | [Array](Array.md).&lt;[String](String.md)&gt; | [static] Array of full-width alphanumeric characters |
| `_editWindow` | [Window_NameEdit](Window_NameEdit.md)       | The name editing window              |
| `_page`     | [Number](Number.md)                           | Page number                          |
| `_index`    | [Number](Number.md)                           | Character index                      |
...
#### drawItem (index)
**@MZ** Overrides: [Window_Selectable](Window_Selectable.md#drawitem-index)

---

#### groupSpacing () → {[Number](Number.md)}
**@MZ** Returns the spacing between groups.

---

#### initialize (rect)
Overrides: [Window_Selectable](Window_Selectable.md#initialize-rect)
...
#### isOk () → {Boolean}
Is OK currently selected?

---

#### isPageChange () → {Boolean}
Is page change currently selected?
...
**@MZ** Overrides: [Window_Selectable](Window_Selectable.md#itemwidth---number)
...
#### onNameAdd ()
Handler called when a name is added.

---

#### onNameOk ()
Handler called when a name is confirmed.
...
**@MZ** Sets the edit window.

##### Arguments

| Name        | Type                            | Description          |
| ----------- | ------------------------------- | -------------------- |
| `editWindow` | [Window_NameEdit](Window_NameEdit.md) | The edit window      |

---

#### table () → {[Array](Array.md).&lt;[Array](Array.md).&lt;[String](String.md)&gt;&gt;}
Returns the array of characters for input.
