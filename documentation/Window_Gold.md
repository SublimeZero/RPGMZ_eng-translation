...
A window that displays the [gold amount].

In MV, the superclass was [Window_Base](Window_Base.md), but it has been changed to [Window_Selectable](Window_Selectable.md) in MZ.
...
#### open ()
Override: [Window_Base](Window_Base.md#open-)
...
Returns the value of [$gameParty](global.md#gameparty-game_party).gold as a number.
