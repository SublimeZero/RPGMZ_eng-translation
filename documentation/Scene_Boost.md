...
A class for the debug screen that opens with the F9 key, used to edit switches and variables.
...
| --------------- | ----------------------------- | ------------------ |
| `_rangeWindow`  | [Window_DebugRange](Window_DebugRange.md) | Range window       |
| `_editWindow`   | [Window_DebugEdit](Window_DebugEdit.md)   | Edit window        |
| `_debugHelpWindow` | [Window_Base](Window_Base.md)        | Help window        |
...
Generates a help window for debugging.

#### createEditWindow ()
Generates an edit window.

#### createRangeWindow ()
Generates a range window.

#### debugHelpWindowRect () → {[Rectangle](Rectangle.md)}
**@MZ** Returns the rectangle area of the help window.

#### editWindowRect () → {[Rectangle](Rectangle.md)}
**@MZ** Returns the rectangle area of the edit window.

#### helpText () → {[String](String.md)}
Returns the text to be displayed in the help window.

#### initialize ()
Override: [Scene_MenuBase](Scene_MenuBase.md#initialize-)

#### needsCancelButton ()
**@MZ** Override: [Scene_MenuBase](Scene_MenuBase.md#needscancelbutton---boolean)

#### onEditCancel ()
Handler called when editing is canceled.

#### onRangeOk ()
Handler called when the range is confirmed.

#### refreshHelpWindow ()
Redraws the help window.

#### rangeWindowRect () → {[Rectangle](Rectangle.md)}
**@MZ** Returns the rectangle area of the range window.
