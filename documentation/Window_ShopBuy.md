...
A window used for selecting purchased items in [shop processing].

Related Classes: [Scene_Shop](Scene_Shop.md), [Window_ShopNumber](Window_ShopNumber.md), [Window_ShopStatus](Window_ShopStatus.md), [Window_Help](Window_Help.md)

### new Window_ShopBuy (rect)
#### Arguments
In MV, the arguments were x, y, height, shopGoods.
...
|------------------|-------------------------------------------|--------------------------------|
| _shopGoods      | [Array](Array.md).&lt;[Array](Array.md).&lt;*&gt;&gt; | An array of [item arrays](#item-array) |
| _money          | [Number](Number.md)                      | Amount of money                |
| _data           | [Array](Array.md).&lt;[RPG.BaseItem](RPG.BaseItem.md)&gt; | Array of items                 |
| _price          | [Array](Array.md).&lt;[Number](Number.md)&gt;  | Array of prices                |
| _statusWindow    | [Window_ShopStatus](Window_ShopStatus.md) | Status window                  |


### Item Array
An array in the order of [Type, Item ID, Price].

| Number | Type                       | Description                      |
|--------|----------------------------|----------------------------------|
| 0      | [Number](Number.md)       | Type (0: Item, 1: Weapon, 2: Armor) |
| 1      | [Number](Number.md)       | Item ID                          |
| 2      | [Number](Number.md)       | Price                            |
...
#### goodsToItem (goods) → {[RPG.BaseItem](RPG.BaseItem.md)}
**@MZ** Returns an array of item objects from the goods array.

##### Arguments

| Name   | Type                               | Description                     |
|--------|------------------------------------|---------------------------------|
| `goods` | [Array](Array.md)                 | An array of [goods](#item-array) |
...
Checks if the specified item is buyable or sellable.
...
#### itemAt (index) → {[RPG.BaseItem](RPG.BaseItem.md)}
Returns the item at the specified product number.
...
#### makeItemList ()
Generates the shop's item list.
...
#### priceWidth (item) → {[Number](Number.md)}
**@MZ** Returns the width of the price display area (default: 96 pixels).
...
| Name   | Type                               | Description                     |
|--------|------------------------------------|---------------------------------|
| `money` | [Number](Number.md)               | Amount of money                 |
...
| Name   | Type                                         | Description                     |
|--------|----------------------------------------------|---------------------------------|
| `shopGoods` | [Array](Array.md).&lt;[Array](Array.md).&lt;*&gt;&gt; | An array of [goods](#item-array) arrays |

---

#### updateHelp ()
Override: [Window_Selectable](Window_Selectable.md#updatehelp-)
