...
## Superclass: [Window_Command](Window_Command.md)

A window for the [Options] commands ([Always Dash], [Command Memory], [BGM Volume], [BGS Volume], [ME Volume], [SE Volume]).

Related classes: [Scene_Options](Scene_Options.md), [Window_TitleCommand](Window_TitleCommand.md), [Window_MenuCommand](Window_MenuCommand.md)

### new Window_Options (rect)
#### Arguments
In MV, there were no arguments.
...
#### addGeneralOptions ()
Adds [Always Dash] and [Command Memory] to the menu.

---

#### addVolumeOptions ()
Adds [BGM Volume], [BGS Volume], [ME Volume], and [SE Volume] to the menu.

---

#### booleanStatusText (value) → {[String](String.md)}
Converts the specified boolean value to "ON" or "OFF" and returns it.
...
Changes the value of the specified symbol.
...
| `value` | Boolean or [Number](Number.md) | Value                |

---

#### changeVolume (symbol, forward, wrap)
**@MZ** Changes the volume value.
...
| ------ | ------------ | --------------------- |
| `symbol` | [String](String.md) | Symbol               |
| `forward` | Boolean | Indicates whether to increase the value |
| `wrap` | Boolean | Indicates whether to loop the value |

---

#### cursorLeft ()
Override: [Window_Selectable](Window_Selectable.md#cursorleft-wrap)

---

#### cursorRight ()
Override: [Window_Selectable](Window_Selectable.md#cursorright-wrap)

---

#### drawItem (index)
Override: [Window_Command](Window_Command.md#drawitem-index)

---

#### getConfigValue (symbol) → {Boolean | Number}
Returns the value of the specified symbol.
...
#### initialize (rect)
Override: [Window_Command](Window_Command.md#initialize-rect)

---

#### isVolumeSymbol (symbol) → {Boolean}
Checks if the specified symbol is related to volume.
...
#### makeCommandList ()
Override: [Window_Command](Window_Command.md#makecommandlist-)

---

#### processOk ()
Override: [Window_Selectable](Window_Command.md#processok-)

---

#### setConfigValue (symbol, value)
Sets the value for the specified symbol.
...
Returns the status string for the specified index.
...
Returns the width of the status (default: 120).

---

#### volumeStatusText (value) → {[String](String.md)}
Returns the specified number with a percentage (%) unit attached.
...
Returns the step value when changing volume (default: 20).

---

### Deprecated MV Methods
updatePlacement (), windowHeight (), windowWidth ()
