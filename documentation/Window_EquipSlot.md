...
A window for selecting [equipment types] in the [Equip] scene.

In MV, the superclass (parent) was [Window_Selectable](Window_Selectable.md), but in MZ it has changed to [Window_StatusBase](Window_StatusBase.md).

Related Class: [Scene_Equip](Scene_Equip.md)

### new Window_EquipSlot (rect)
#### Arguments
...
|----------------|--------------------------|------------------------|
| _actor         | [Game_Actor](Game_Actor.md)         | Actor                  |
| _itemWindow    | [Window_EquipItem](Window_EquipItem.md) | Item selection window  |
| _statusWindow  | [Window_EquipStatus](Window_EquipStatus.md) | Status window         |
...
Checks if the specified [equipment type] is available.

##### Arguments

| Name   | Type                | Description           |
|--------|---------------------|-----------------------|
| `index` | [Number](Number.md) | [Equipment type] number |
...
#### itemAt (index) → {[RPG.EquipItem](RPG.EquipItem.md)}
**@MZ** Returns the equipment for the specified item number.
...
| Name   | Type                | Description           |
|--------|---------------------|-----------------------|
| `itemWindow` | [Window_EquipItem](Window_EquipItem.md) | Item window           |
...
| Name   | Type                | Description           |
|--------|---------------------|-----------------------|
| `statusWindow` | [Window_EquipStatus](Window_EquipStatus.md) | Status window         |

---

#### slotNameWidth () → {[Number](Number.md)}
**@MZ** Returns the width of the [equipment type] name display (default: 138 pixels).
