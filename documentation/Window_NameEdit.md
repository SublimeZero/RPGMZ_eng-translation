...
A window for editing an actor's name during [name input processing].

In MV, the superclass was [Window_Base](Window_Base.md), but in MZ, it has been changed to [Window_StatusBase](Window_StatusBase.md).
...
#### Arguments
In MV, the arguments were `actor` and `maxLength`.
...
| `_maxLength`    | [Number](Number.md)             | Maximum character count |
| `_name`         | [String](String.md)             | Name                 |
| `_index`        | [Number](Number.md)             | Index                |
| `_defaultName`  | [String](String.md)             | Default name         |
...
#### add (ch) → {Boolean}
Adds a character and returns whether it was successful.

##### Arguments

| Name | Type               | Description         |
| ---- | ------------------ | ------------------- |
| `ch` | [String](String.md) | Character to add    |

---

#### back () → {Boolean}
Moves back by one character.

---

#### charWidth () → {[Number](Number.md)}
Returns the width (in pixels) of the character 'A'.
...
| Name   | Type               | Description     |
| ------ | ------------------ | --------------- |
| `index` | [Number](Number.md) | Position        |

---

#### drawUnderline (index)
Draws an underline at the specified position.
...
Returns the width of the [face] image.

---

#### initialize (rect)
Overrides: [Window_StatusBase](Window_StatusBase.md#initialize-rect)

---

#### itemRect (index) → {[Rectangle](Rectangle.md)}
Returns the rectangular area occupied by the character at the specified position.
...
Restores the name to its default value.

---

#### setup (actor, maxLength)
**@MZ** Performs the initial setup.
...
Returns the rectangular area of the underline at the specified position.
