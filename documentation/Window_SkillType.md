...
A selection window for [skill types] ( [magic][special skills] ).

Related classes: [Scene_Skill](Scene_Skill.md)
...
| --- | --- | --- |
| `_actor` | [Game_Actor](Game_Actor.md) | Target actor |
| `_skillWindow` | [Window_SkillList](Window_SkillList.md) | Skill window |
...
#### selectLast ()
Select the last chosen menu.

---

#### setActor (actor)
Set the specified actor.
...
Set the specified skill window.

##### Arguments

| Name | Type | Description |
| --- | --- | --- |
| `skillWindow` | [Window_SkillList](Window_SkillList.md) | Skill window |
