...
| ------------------ | ------------------------------ | ---------------------------- |
| `_categoryWindow`  | [Window_ItemCategory](Window_ItemCategory.md) | Category selection window |
...
**@MZ** Returns the rectangular area of the category window.
...
#### onItemCancel ()
Handler called when the item selection is canceled.

#### onItemOk ()
Handler called when an item is selected.

#### playSeForItem ()
Plays the sound set for [item use].
